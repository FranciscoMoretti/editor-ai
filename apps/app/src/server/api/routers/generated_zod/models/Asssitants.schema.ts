 ...
 */
export const AsssitantsSchema = AsssitantsScalarSchema.merge(fkSchema).merge(
 ...
 * @private
 */
export const AsssitantsPrismaUpdateSchema = z
  .object({
    assistant_id: z.string().uuid(),
    graph_id: z.string(),
    created_at: z.coerce.date().default(() => new Date()),
 ...
 */
export const AsssitantsCreateSchema =
  AsssitantsCreateScalarSchema.merge(fkSchema);
 ...
 */
export const AsssitantsUpdateSchema = AsssitantsUpdateScalarSchema.merge(
  fkSchema.partial(),
);
