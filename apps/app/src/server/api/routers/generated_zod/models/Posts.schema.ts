 ...
 */
export const PostsSchema = PostsScalarSchema.merge(fkSchema).merge(relationSchema.partial());
 ...
 * @private
 */
export const PostsPrismaUpdateSchema = z.object({
    id: z.string().uuid(),
    title: z.string(),
    content: z.string(),
    created_at: z.coerce.date().default(() => new Date()),
 ...
 */
export const PostsUpdateSchema = PostsUpdateScalarSchema.merge(fkSchema.partial());
