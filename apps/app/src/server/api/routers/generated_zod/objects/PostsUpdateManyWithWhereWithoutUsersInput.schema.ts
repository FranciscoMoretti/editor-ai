...
export const PostsUpdateManyWithWhereWithoutUsersInputObjectSchema: SchemaType = z.object({
    where: z.lazy(() => PostsScalarWhereInputObjectSchema), data: z.union([z.lazy(() => PostsUpdateManyMutationInputObjectSchema), z.lazy(() => PostsUncheckedUpdateManyWithoutUsersInputObjectSchema)])
