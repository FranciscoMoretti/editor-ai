...
export const UsersOrderByWithAggregationInputObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => SortOrderInputObjectSchema)]).optional(), _count: z.lazy(() => UsersCountOrderByAggregateInputObjectSchema).optional(), _max: z.lazy(() => UsersMaxOrderByAggregateInputObjectSchema).optional(), _min: z.lazy(() => UsersMinOrderByAggregateInputObjectSchema).optional()
