...
type SchemaType =
  z.ZodType<Prisma.asssitantsUpdateWithWhereUniqueWithoutConfigInput>;
export const AsssitantsUpdateWithWhereUniqueWithoutConfigInputObjectSchema: SchemaType =
  z
    .object({
