...
type SchemaType = z.ZodType<Prisma.postsUncheckedUpdateWithoutUsersInput>;
export const PostsUncheckedUpdateWithoutUsersInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
