...
type SchemaType =
  z.ZodType<Prisma.asssitantsUncheckedUpdateManyWithoutConfigNestedInput>;
export const AsssitantsUncheckedUpdateManyWithoutConfigNestedInputObjectSchema: SchemaType =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => AsssitantsUpsertWithWhereUniqueWithoutConfigInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      update: z
        .union([
          z.lazy(
            () => AsssitantsUpdateWithWhereUniqueWithoutConfigInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () => AsssitantsUpdateManyWithWhereWithoutConfigInputObjectSchema,
          ),
          z
            .lazy(
              () => AsssitantsUpdateManyWithWhereWithoutConfigInputObjectSchema,
