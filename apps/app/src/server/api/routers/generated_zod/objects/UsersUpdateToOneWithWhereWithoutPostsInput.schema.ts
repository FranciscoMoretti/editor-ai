...
export const UsersUpdateToOneWithWhereWithoutPostsInputObjectSchema: SchemaType = z.object({
    where: z.lazy(() => UsersWhereInputObjectSchema).optional(), data: z.union([z.lazy(() => UsersUpdateWithoutPostsInputObjectSchema), z.lazy(() => UsersUncheckedUpdateWithoutPostsInputObjectSchema)])
