...
export const UsersCreateInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), posts: z.lazy(() => PostsCreateNestedManyWithoutUsersInputObjectSchema).optional(), assistants: z.lazy(() => AsssitantCreateNestedManyWithoutUsersInputObjectSchema).optional()
