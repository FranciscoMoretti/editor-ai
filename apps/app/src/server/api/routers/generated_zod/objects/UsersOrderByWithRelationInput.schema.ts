...
export const UsersOrderByWithRelationInputObjectSchema: SchemaType = z
  .object({
    ...
    updated_at: z
      ...
      .optional(),
    posts: z
      .lazy(() => PostsOrderByRelationAggregateInputObjectSchema)
      .optional(),
    assistants: z
      .lazy(() => AsssitantsOrderByRelationAggregateInputObjectSchema)
      .optional(),
  })
