...
type SchemaType = z.ZodType<Prisma.asssitantWhereUniqueInput>;
export const AsssitantWhereUniqueInputObjectSchema: SchemaType = z.object({
    assistant_id: z.string().optional(), AND: z.union([z.lazy(() => AsssitantWhereInputObjectSchema),
    ...
    z.lazy(() => AsssitantWhereInputObjectSchema).array()]).optional(), graph_id: z.union([z.lazy(() => StringFilterObjectSchema),
