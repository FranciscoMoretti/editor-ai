...
export const PostsWhereInputObjectSchema: SchemaType = z
  .object({
    AND: z
      .union([
        z.lazy(() => PostsWhereInputObjectSchema),
        z.lazy(() => PostsWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => PostsWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
