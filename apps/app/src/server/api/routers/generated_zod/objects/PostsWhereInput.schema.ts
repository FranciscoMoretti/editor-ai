...
type SchemaType = z.ZodType<Prisma.postsWhereInput>;
export const PostsWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => PostsWhereInputObjectSchema),
    ...
    z.lazy(() => PostsWhereInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => UuidFilterObjectSchema),
