...
type SchemaType = z.ZodType<Prisma.asssitantsCreateWithoutUsersInput>;
export const AsssitantsCreateWithoutUsersInputObjectSchema: SchemaType = z.object({
    assistant_id: z.string().optional(), graph_id: z.string(), created_at: z.union([z.date().optional(), z.string().datetime().optional()]), updated_at: z.union([z.date().optional(), z.string().datetime().optional()]), metadata: z.union([z.lazy(() => JsonNullValueInputSchema),
        jsonSchema]).optional(), version: z.number().optional(), name: z.string().optional(), config: z.lazy(() => ConfigsCreateNestedOneWithoutAssistantsInputObjectSchema)
