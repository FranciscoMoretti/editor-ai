...
type SchemaType = z.ZodType<Prisma.asssitantsUncheckedUpdateManyWithoutUsersInput>;
export const AsssitantsUncheckedUpdateManyWithoutUsersInputObjectSchema: SchemaType = z.object({
    assistant_id: z.union([z.string(),
    z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(), graph_id: z.union([z.string(),
    z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(), config_id: z.union([z.string(),
