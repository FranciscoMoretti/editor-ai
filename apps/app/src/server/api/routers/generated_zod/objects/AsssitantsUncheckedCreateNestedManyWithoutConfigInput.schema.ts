...
type SchemaType = z.ZodType<Prisma.asssitantsUncheckedCreateNestedManyWithoutConfigInput>;
export const AsssitantsUncheckedCreateNestedManyWithoutConfigInputObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => AsssitantsCreateOrConnectWithoutConfigInputObjectSchema).array()]).optional(), createMany: z.lazy(() => AsssitantsCreateManyConfigInputEnvelopeObjectSchema).optional(), connect: z.union([z.lazy(() => AsssitantsWhereUniqueInputObjectSchema),
