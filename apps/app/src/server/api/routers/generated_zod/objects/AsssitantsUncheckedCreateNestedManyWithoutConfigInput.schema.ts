...
type SchemaType =
  z.ZodType<Prisma.asssitantsUncheckedCreateNestedManyWithoutConfigInput>;
export const AsssitantsUncheckedCreateNestedManyWithoutConfigInputObjectSchema: SchemaType =
  z
    .object({
      create: z
        .union([
