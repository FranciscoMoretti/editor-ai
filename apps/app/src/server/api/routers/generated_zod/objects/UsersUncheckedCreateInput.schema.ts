...
export const UsersUncheckedCreateInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), posts: z.lazy(() => PostsUncheckedCreateNestedManyWithoutUsersInputObjectSchema).optional(), assistants: z.lazy(() => AsssitantUncheckedCreateNestedManyWithoutUsersInputObjectSchema).optional()
