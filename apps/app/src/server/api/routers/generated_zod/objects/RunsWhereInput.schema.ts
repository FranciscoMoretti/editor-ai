...
export const RunsWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => RunsWhereInputObjectSchema),
    ...
    z.lazy(() => RunsWhereInputObjectSchema).array()]).optional(), run_id: z.union([z.lazy(() => UuidFilterObjectSchema),
