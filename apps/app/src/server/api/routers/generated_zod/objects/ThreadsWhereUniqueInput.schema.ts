...
export const ThreadsWhereUniqueInputObjectSchema: SchemaType = z.object({
    thread_id: z.string().optional(), AND: z.union([z.lazy(() => ThreadsWhereInputObjectSchema),
    ...
    z.lazy(() => ThreadsWhereInputObjectSchema).array()]).optional(), created_at: z.union([z.lazy(() => DateTimeFilterObjectSchema),
