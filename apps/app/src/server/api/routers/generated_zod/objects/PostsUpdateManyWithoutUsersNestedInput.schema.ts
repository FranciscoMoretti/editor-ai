...
type SchemaType = z.ZodType<Prisma.postsUpdateManyWithoutUsersNestedInput>;
export const PostsUpdateManyWithoutUsersNestedInputObjectSchema: SchemaType = z
  .object({
    create: z
      .union([
        z.lazy(() => PostsCreateWithoutUsersInputObjectSchema),
        z.lazy(() => PostsCreateWithoutUsersInputObjectSchema).array(),
        z.lazy(() => PostsUncheckedCreateWithoutUsersInputObjectSchema),
        z.lazy(() => PostsUncheckedCreateWithoutUsersInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => PostsCreateOrConnectWithoutUsersInputObjectSchema),
        z.lazy(() => PostsCreateOrConnectWithoutUsersInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
        z.lazy(() => PostsUpsertWithWhereUniqueWithoutUsersInputObjectSchema),
        z
          .lazy(() => PostsUpsertWithWhereUniqueWithoutUsersInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
      .lazy(() => PostsCreateManyUsersInputEnvelopeObjectSchema)
      .optional(),
    set: z
      .union([
        z.lazy(() => PostsWhereUniqueInputObjectSchema),
        z.lazy(() => PostsWhereUniqueInputObjectSchema).array(),
      ])
      .optional(),
    disconnect: z
      .union([
    ...
    update: z
      .union([
        z.lazy(() => PostsUpdateWithWhereUniqueWithoutUsersInputObjectSchema),
        z
          .lazy(() => PostsUpdateWithWhereUniqueWithoutUsersInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
      .union([
        z.lazy(() => PostsUpdateManyWithWhereWithoutUsersInputObjectSchema),
        z
          .lazy(() => PostsUpdateManyWithWhereWithoutUsersInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
      .union([
        z.lazy(() => PostsScalarWhereInputObjectSchema),
        z.lazy(() => PostsScalarWhereInputObjectSchema).array(),
      ])
      .optional(),
  })
