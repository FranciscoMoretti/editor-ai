...
type SchemaType = z.ZodType<Prisma.usersUpdateWithoutAssistantsInput>;
export const UsersUpdateWithoutAssistantsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => NullableDateTimeFieldUpdateOperationsInputObjectSchema),
    z.null()]).optional().nullable(), posts: z.lazy(() => PostsUpdateManyWithoutUsersNestedInputObjectSchema).optional()
