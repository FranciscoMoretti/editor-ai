...
export const ConfigsSelectObjectSchema: SchemaType = z.object({
    config_id: z.boolean().optional(), user_id: z.boolean().optional(), tags: z.boolean().optional(), recursion_limit: z.boolean().optional(), configurable: z.boolean().optional(), assistants: z.union([z.boolean(),
