...
type SchemaType = z.ZodType<Prisma.runsUncheckedUpdateManyInput>;
export const RunsUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), status: z.union([z.lazy(() => RunStatusSchema),
    z.lazy(() => EnumRunStatusFieldUpdateOperationsInputObjectSchema)]).optional(), metadata: z.union([z.lazy(() => JsonNullValueInputSchema),
        jsonSchema]).optional(), kwargs: z.union([z.lazy(() => JsonNullValueInputSchema),
            jsonSchema]).optional(), multitask_strategy: z.union([z.lazy(() => MultitaskStrategySchema),
            z.lazy(() => EnumMultitaskStrategyFieldUpdateOperationsInputObjectSchema)]).optional()
