...
export const PostsUpsertWithWhereUniqueWithoutUsersInputObjectSchema: SchemaType = z.object({
    where: z.lazy(() => PostsWhereUniqueInputObjectSchema), update: z.union([z.lazy(() => PostsUpdateWithoutUsersInputObjectSchema), z.lazy(() => PostsUncheckedUpdateWithoutUsersInputObjectSchema)]), create: z.union([z.lazy(() => PostsCreateWithoutUsersInputObjectSchema), z.lazy(() => PostsUncheckedCreateWithoutUsersInputObjectSchema)])
