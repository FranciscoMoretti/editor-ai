...
type SchemaType =
  z.ZodType<Prisma.asssitantsUncheckedCreateNestedManyWithoutUsersInput>;
export const AsssitantsUncheckedCreateNestedManyWithoutUsersInputObjectSchema: SchemaType =
  z
    .object({
      create: z
        .union([
