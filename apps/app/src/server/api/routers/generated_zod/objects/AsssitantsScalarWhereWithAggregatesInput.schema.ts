...
export const AsssitantsScalarWhereWithAggregatesInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => AsssitantsScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => AsssitantsScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), OR: z.lazy(() => AsssitantsScalarWhereWithAggregatesInputObjectSchema).array().optional(), NOT: z.union([z.lazy(() => AsssitantsScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => AsssitantsScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), assistant_id: z.union([z.lazy(() => UuidWithAggregatesFilterObjectSchema),
