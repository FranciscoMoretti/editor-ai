...
type SchemaType =
  z.ZodType<Prisma.asssitantsUpsertWithWhereUniqueWithoutUsersInput>;
export const AsssitantsUpsertWithWhereUniqueWithoutUsersInputObjectSchema: SchemaType =
  z
    .object({
      where: z.lazy(() => AsssitantsWhereUniqueInputObjectSchema),
      update: z.union([
        z.lazy(() => AsssitantsUpdateWithoutUsersInputObjectSchema),
        z.lazy(() => AsssitantsUncheckedUpdateWithoutUsersInputObjectSchema),
      ]),
      create: z.union([
