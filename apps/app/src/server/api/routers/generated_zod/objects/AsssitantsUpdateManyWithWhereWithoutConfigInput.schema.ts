...
type SchemaType =
  z.ZodType<Prisma.asssitantsUpdateManyWithWhereWithoutConfigInput>;
export const AsssitantsUpdateManyWithWhereWithoutConfigInputObjectSchema: SchemaType =
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(
          () => AsssitantsUncheckedUpdateManyWithoutConfigInputObjectSchema,
        ),
      ]),
    })
