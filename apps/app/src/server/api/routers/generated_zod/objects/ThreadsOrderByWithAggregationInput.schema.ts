...
export const ThreadsOrderByWithAggregationInputObjectSchema: SchemaType = z
  .object({
    ...
    _count: z
      .lazy(() => ThreadsCountOrderByAggregateInputObjectSchema)
      .optional(),
    _max: z.lazy(() => ThreadsMaxOrderByAggregateInputObjectSchema).optional(),
    _min: z.lazy(() => ThreadsMinOrderByAggregateInputObjectSchema).optional(),
  })
