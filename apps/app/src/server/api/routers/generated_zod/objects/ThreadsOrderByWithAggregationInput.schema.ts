...
export const ThreadsOrderByWithAggregationInputObjectSchema: SchemaType = z.object({
    thread_id: z.lazy(() => SortOrderSchema).optional(), user_id: z.lazy(() => SortOrderSchema).optional(), created_at: z.lazy(() => SortOrderSchema).optional(), updated_at: z.lazy(() => SortOrderSchema).optional(), metadata: z.lazy(() => SortOrderSchema).optional(), status: z.lazy(() => SortOrderSchema).optional(), values: z.lazy(() => SortOrderSchema).optional(), _count: z.lazy(() => ThreadsCountOrderByAggregateInputObjectSchema).optional(), _max: z.lazy(() => ThreadsMaxOrderByAggregateInputObjectSchema).optional(), _min: z.lazy(() => ThreadsMinOrderByAggregateInputObjectSchema).optional()
