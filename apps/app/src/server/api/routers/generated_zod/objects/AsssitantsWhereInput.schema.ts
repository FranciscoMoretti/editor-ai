...
type SchemaType = z.ZodType<Prisma.asssitantsWhereInput>;
export const AsssitantsWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => AsssitantsWhereInputObjectSchema),
    ...
    z.lazy(() => AsssitantsWhereInputObjectSchema).array()]).optional(), assistant_id: z.union([z.lazy(() => UuidFilterObjectSchema),
