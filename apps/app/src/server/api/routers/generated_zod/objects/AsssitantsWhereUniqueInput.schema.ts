...
export const AsssitantsWhereUniqueInputObjectSchema: SchemaType = z
  .object({
    assistant_id: z.string().optional(),
    AND: z
      .union([
        z.lazy(() => AsssitantsWhereInputObjectSchema),
        z.lazy(() => AsssitantsWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => AsssitantsWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
    ...
    config: z
      .union([
        z.lazy(() => ConfigsRelationFilterObjectSchema),
