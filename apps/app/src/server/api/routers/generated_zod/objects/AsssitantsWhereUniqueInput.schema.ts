...
type SchemaType = z.ZodType<Prisma.asssitantsWhereUniqueInput>;
export const AsssitantsWhereUniqueInputObjectSchema: SchemaType = z.object({
    assistant_id: z.string().optional(), AND: z.union([z.lazy(() => AsssitantsWhereInputObjectSchema),
    z.lazy(() => AsssitantsWhereInputObjectSchema).array()]).optional(), OR: z.lazy(() => AsssitantsWhereInputObjectSchema).array().optional(), NOT: z.union([z.lazy(() => AsssitantsWhereInputObjectSchema),
    z.lazy(() => AsssitantsWhereInputObjectSchema).array()]).optional(), user_id: z.union([z.lazy(() => UuidFilterObjectSchema),
