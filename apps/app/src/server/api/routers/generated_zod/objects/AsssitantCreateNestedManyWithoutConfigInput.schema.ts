...
type SchemaType = z.ZodType<Prisma.asssitantCreateNestedManyWithoutConfigInput>;
export const AsssitantCreateNestedManyWithoutConfigInputObjectSchema: SchemaType = z.object({
