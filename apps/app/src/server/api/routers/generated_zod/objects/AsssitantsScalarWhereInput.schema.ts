...
type SchemaType = z.ZodType<Prisma.asssitantsScalarWhereInput>;
export const AsssitantsScalarWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => AsssitantsScalarWhereInputObjectSchema),
    z.lazy(() => AsssitantsScalarWhereInputObjectSchema).array()]).optional(), OR: z.lazy(() => AsssitantsScalarWhereInputObjectSchema).array().optional(), NOT: z.union([z.lazy(() => AsssitantsScalarWhereInputObjectSchema),
    z.lazy(() => AsssitantsScalarWhereInputObjectSchema).array()]).optional(), assistant_id: z.union([z.lazy(() => UuidFilterObjectSchema),
