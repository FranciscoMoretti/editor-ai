...
type SchemaType =
  z.ZodType<Prisma.configsUpdateToOneWithWhereWithoutAssistantsInput>;
export const ConfigsUpdateToOneWithWhereWithoutAssistantsInputObjectSchema: SchemaType =
  z
    .object({
      where: z.lazy(() => ConfigsWhereInputObjectSchema).optional(),
      data: z.union([
