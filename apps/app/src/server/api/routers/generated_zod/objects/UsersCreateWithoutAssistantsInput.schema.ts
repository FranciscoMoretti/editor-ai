...
type SchemaType = z.ZodType<Prisma.usersCreateWithoutAssistantsInput>;
export const UsersCreateWithoutAssistantsInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), posts: z.lazy(() => PostsCreateNestedManyWithoutUsersInputObjectSchema).optional()
