...
type SchemaType =
  z.ZodType<Prisma.configsCreateOrConnectWithoutAssistantsInput>;
export const ConfigsCreateOrConnectWithoutAssistantsInputObjectSchema: SchemaType =
  z
    .object({
      where: z.lazy(() => ConfigsWhereUniqueInputObjectSchema),
      create: z.union([
