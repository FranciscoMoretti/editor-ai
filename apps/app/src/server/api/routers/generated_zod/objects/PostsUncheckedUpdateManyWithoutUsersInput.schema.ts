...
type SchemaType = z.ZodType<Prisma.postsUncheckedUpdateManyWithoutUsersInput>;
export const PostsUncheckedUpdateManyWithoutUsersInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
