...
import { ConfigsUpdateOneRequiredWithoutAssistantsNestedInputObjectSchema } from './ConfigsUpdateOneRequiredWithoutAssistantsNestedInput.schema';
...
type SchemaType = z.ZodType<Prisma.asssitantsUpdateInput>;
export const AsssitantsUpdateInputObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), metadata: z.union([z.lazy(() => JsonNullValueInputSchema),
        ...
        z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(), config: z.lazy(() => ConfigsUpdateOneRequiredWithoutAssistantsNestedInputObjectSchema).optional(), users: z.lazy(() => UsersUpdateOneRequiredWithoutAssistantsNestedInputObjectSchema).optional()
