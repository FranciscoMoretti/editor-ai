...
type SchemaType = z.ZodType<Prisma.configsUpdateOneRequiredWithoutAssistantsNestedInput>;
export const ConfigsUpdateOneRequiredWithoutAssistantsNestedInputObjectSchema: SchemaType = z.object({
    create: z.union([z.lazy(() => ConfigsCreateWithoutAssistantsInputObjectSchema), z.lazy(() => ConfigsUncheckedCreateWithoutAssistantsInputObjectSchema)]).optional(), connectOrCreate: z.lazy(() => ConfigsCreateOrConnectWithoutAssistantsInputObjectSchema).optional(), upsert: z.lazy(() => ConfigsUpsertWithoutAssistantsInputObjectSchema).optional(), connect: z.lazy(() => ConfigsWhereUniqueInputObjectSchema).optional(), update: z.union([z.lazy(() => ConfigsUpdateToOneWithWhereWithoutAssistantsInputObjectSchema), z.lazy(() => ConfigsUpdateWithoutAssistantsInputObjectSchema), z.lazy(() => ConfigsUncheckedUpdateWithoutAssistantsInputObjectSchema)]).optional()
