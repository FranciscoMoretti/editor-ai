...
export const AsssitantsCreateOrConnectWithoutConfigInputObjectSchema: SchemaType = z.object({
    where: z.lazy(() => AsssitantsWhereUniqueInputObjectSchema), create: z.union([z.lazy(() => AsssitantsCreateWithoutConfigInputObjectSchema), z.lazy(() => AsssitantsUncheckedCreateWithoutConfigInputObjectSchema)])
