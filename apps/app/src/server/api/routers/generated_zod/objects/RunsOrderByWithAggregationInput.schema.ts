...
export const RunsOrderByWithAggregationInputObjectSchema: SchemaType = z.object({
    run_id: z.lazy(() => SortOrderSchema).optional(), thread_id: z.lazy(() => SortOrderSchema).optional(), assistant_id: z.lazy(() => SortOrderSchema).optional(), created_at: z.lazy(() => SortOrderSchema).optional(), updated_at: z.lazy(() => SortOrderSchema).optional(), status: z.lazy(() => SortOrderSchema).optional(), metadata: z.lazy(() => SortOrderSchema).optional(), kwargs: z.lazy(() => SortOrderSchema).optional(), multitask_strategy: z.lazy(() => SortOrderSchema).optional(), _count: z.lazy(() => RunsCountOrderByAggregateInputObjectSchema).optional(), _max: z.lazy(() => RunsMaxOrderByAggregateInputObjectSchema).optional(), _min: z.lazy(() => RunsMinOrderByAggregateInputObjectSchema).optional()
