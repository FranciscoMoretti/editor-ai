...
export const RunsOrderByWithAggregationInputObjectSchema: SchemaType = z
  .object({
    ...
    kwargs: z.lazy(() => SortOrderSchema).optional(),
    multitask_strategy: z.lazy(() => SortOrderSchema).optional(),
    _count: z.lazy(() => RunsCountOrderByAggregateInputObjectSchema).optional(),
    _max: z.lazy(() => RunsMaxOrderByAggregateInputObjectSchema).optional(),
    _min: z.lazy(() => RunsMinOrderByAggregateInputObjectSchema).optional(),
  })
