...
export const UsersCreateOrConnectWithoutPostsInputObjectSchema: SchemaType = z.object({
    where: z.lazy(() => UsersWhereUniqueInputObjectSchema), create: z.union([z.lazy(() => UsersCreateWithoutPostsInputObjectSchema), z.lazy(() => UsersUncheckedCreateWithoutPostsInputObjectSchema)])
