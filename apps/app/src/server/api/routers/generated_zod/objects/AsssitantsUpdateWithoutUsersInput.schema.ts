...
type SchemaType = z.ZodType<Prisma.asssitantsUpdateWithoutUsersInput>;
export const AsssitantsUpdateWithoutUsersInputObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), metadata: z.union([z.lazy(() => JsonNullValueInputSchema),
        ...
        z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(), config: z.lazy(() => ConfigsUpdateOneRequiredWithoutAssistantsNestedInputObjectSchema).optional()
