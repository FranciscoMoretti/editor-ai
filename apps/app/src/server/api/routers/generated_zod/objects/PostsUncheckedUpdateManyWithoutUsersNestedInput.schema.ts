...
type SchemaType =
  z.ZodType<Prisma.postsUncheckedUpdateManyWithoutUsersNestedInput>;
export const PostsUncheckedUpdateManyWithoutUsersNestedInputObjectSchema: SchemaType =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => PostsUncheckedCreateWithoutUsersInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => PostsCreateOrConnectWithoutUsersInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
