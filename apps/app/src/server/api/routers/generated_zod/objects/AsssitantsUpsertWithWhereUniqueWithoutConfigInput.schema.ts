...
type SchemaType =
  z.ZodType<Prisma.asssitantsUpsertWithWhereUniqueWithoutConfigInput>;
export const AsssitantsUpsertWithWhereUniqueWithoutConfigInputObjectSchema: SchemaType =
  z
    .object({
      where: z.lazy(() => AsssitantsWhereUniqueInputObjectSchema),
      update: z.union([
        z.lazy(() => AsssitantsUpdateWithoutConfigInputObjectSchema),
        z.lazy(() => AsssitantsUncheckedUpdateWithoutConfigInputObjectSchema),
      ]),
      create: z.union([
