...
export const AsssitantsOrderByWithAggregationInputObjectSchema: SchemaType = z
  .object({
    assistant_id: z.lazy(() => SortOrderSchema).optional(),
    user_id: z.lazy(() => SortOrderSchema).optional(),
    graph_id: z.lazy(() => SortOrderSchema).optional(),
    ...
    _count: z
      .lazy(() => AsssitantsCountOrderByAggregateInputObjectSchema)
      .optional(),
    _avg: z
      .lazy(() => AsssitantsAvgOrderByAggregateInputObjectSchema)
      .optional(),
    _max: z
      .lazy(() => AsssitantsMaxOrderByAggregateInputObjectSchema)
      .optional(),
    _min: z
      .lazy(() => AsssitantsMinOrderByAggregateInputObjectSchema)
      .optional(),
    _sum: z
      .lazy(() => AsssitantsSumOrderByAggregateInputObjectSchema)
      .optional(),
  })
