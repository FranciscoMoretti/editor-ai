...
export const PostsOrderByWithAggregationInputObjectSchema: SchemaType = z
  .object({
    ...
    _count: z
      .lazy(() => PostsCountOrderByAggregateInputObjectSchema)
      .optional(),
    _max: z.lazy(() => PostsMaxOrderByAggregateInputObjectSchema).optional(),
    _min: z.lazy(() => PostsMinOrderByAggregateInputObjectSchema).optional(),
  })
