...
type SchemaType =
  z.ZodType<Prisma.asssitantsUncheckedUpdateManyWithoutUsersNestedInput>;
export const AsssitantsUncheckedUpdateManyWithoutUsersNestedInputObjectSchema: SchemaType =
  z
    .object({
      create: z
        .union([
          z.lazy(() => AsssitantsCreateWithoutUsersInputObjectSchema),
          z.lazy(() => AsssitantsCreateWithoutUsersInputObjectSchema).array(),
          z.lazy(() => AsssitantsUncheckedCreateWithoutUsersInputObjectSchema),
          z
            .lazy(() => AsssitantsUncheckedCreateWithoutUsersInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => AsssitantsCreateOrConnectWithoutUsersInputObjectSchema),
          z
            .lazy(() => AsssitantsCreateOrConnectWithoutUsersInputObjectSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(
            () => AsssitantsUpsertWithWhereUniqueWithoutUsersInputObjectSchema,
          ),
          z
            .lazy(
              () =>
        ...
        .optional(),
      createMany: z
        .lazy(() => AsssitantsCreateManyUsersInputEnvelopeObjectSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () => AsssitantsUpdateWithWhereUniqueWithoutUsersInputObjectSchema,
          ),
          z
            .lazy(
              () =>
      ...
      updateMany: z
        .union([
          z.lazy(
            () => AsssitantsUpdateManyWithWhereWithoutUsersInputObjectSchema,
          ),
          z
            .lazy(
              () => AsssitantsUpdateManyWithWhereWithoutUsersInputObjectSchema,
      ...
      deleteMany: z
        .union([
          z.lazy(() => AsssitantsScalarWhereInputObjectSchema),
          z.lazy(() => AsssitantsScalarWhereInputObjectSchema).array(),
        ])
        .optional(),
    })
