...
type SchemaType = z.ZodType<Prisma.usersUncheckedUpdateWithoutAssistantsInput>;
export const UsersUncheckedUpdateWithoutAssistantsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => NullableDateTimeFieldUpdateOperationsInputObjectSchema),
    z.null()]).optional().nullable(), posts: z.lazy(() => PostsUncheckedUpdateManyWithoutUsersNestedInputObjectSchema).optional()
