...
export const UsersUpsertWithoutPostsInputObjectSchema: SchemaType = z.object({
    update: z.union([z.lazy(() => UsersUpdateWithoutPostsInputObjectSchema), z.lazy(() => UsersUncheckedUpdateWithoutPostsInputObjectSchema)]), create: z.union([z.lazy(() => UsersCreateWithoutPostsInputObjectSchema), z.lazy(() => UsersUncheckedCreateWithoutPostsInputObjectSchema)]), where: z.lazy(() => UsersWhereInputObjectSchema).optional()
