...
export const PostsCreateOrConnectWithoutUsersInputObjectSchema: SchemaType = z.object({
    where: z.lazy(() => PostsWhereUniqueInputObjectSchema), create: z.union([z.lazy(() => PostsCreateWithoutUsersInputObjectSchema), z.lazy(() => PostsUncheckedCreateWithoutUsersInputObjectSchema)])
