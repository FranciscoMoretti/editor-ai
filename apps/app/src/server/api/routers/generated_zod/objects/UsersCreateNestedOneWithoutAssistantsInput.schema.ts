...
export const UsersCreateNestedOneWithoutAssistantsInputObjectSchema: SchemaType = z.object({
    create: z.union([z.lazy(() => UsersCreateWithoutAssistantsInputObjectSchema), z.lazy(() => UsersUncheckedCreateWithoutAssistantsInputObjectSchema)]).optional(), connectOrCreate: z.lazy(() => UsersCreateOrConnectWithoutAssistantsInputObjectSchema).optional(), connect: z.lazy(() => UsersWhereUniqueInputObjectSchema).optional()
