...
type SchemaType = z.ZodType<Prisma.usersUpdateOneRequiredWithoutAssistantsNestedInput>;
export const UsersUpdateOneRequiredWithoutAssistantsNestedInputObjectSchema: SchemaType = z.object({
    create: z.union([z.lazy(() => UsersCreateWithoutAssistantsInputObjectSchema), z.lazy(() => UsersUncheckedCreateWithoutAssistantsInputObjectSchema)]).optional(), connectOrCreate: z.lazy(() => UsersCreateOrConnectWithoutAssistantsInputObjectSchema).optional(), upsert: z.lazy(() => UsersUpsertWithoutAssistantsInputObjectSchema).optional(), connect: z.lazy(() => UsersWhereUniqueInputObjectSchema).optional(), update: z.union([z.lazy(() => UsersUpdateToOneWithWhereWithoutAssistantsInputObjectSchema), z.lazy(() => UsersUpdateWithoutAssistantsInputObjectSchema), z.lazy(() => UsersUncheckedUpdateWithoutAssistantsInputObjectSchema)]).optional()
