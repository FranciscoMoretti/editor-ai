...
type SchemaType = z.ZodType<Prisma.usersUpdateOneRequiredWithoutPostsNestedInput>;
export const UsersUpdateOneRequiredWithoutPostsNestedInputObjectSchema: SchemaType = z.object({
    create: z.union([z.lazy(() => UsersCreateWithoutPostsInputObjectSchema), z.lazy(() => UsersUncheckedCreateWithoutPostsInputObjectSchema)]).optional(), connectOrCreate: z.lazy(() => UsersCreateOrConnectWithoutPostsInputObjectSchema).optional(), upsert: z.lazy(() => UsersUpsertWithoutPostsInputObjectSchema).optional(), connect: z.lazy(() => UsersWhereUniqueInputObjectSchema).optional(), update: z.union([z.lazy(() => UsersUpdateToOneWithWhereWithoutPostsInputObjectSchema), z.lazy(() => UsersUpdateWithoutPostsInputObjectSchema), z.lazy(() => UsersUncheckedUpdateWithoutPostsInputObjectSchema)]).optional()
