...
export const ConfigsArgsObjectSchema: SchemaType = z.object({
    select: z.lazy(() => ConfigsSelectObjectSchema).optional(), include: z.lazy(() => ConfigsIncludeObjectSchema).optional()
