...
export const RunsInputSchema = {
  findUnique: z
    .object({
      ...
      where: RunsWhereUniqueInputObjectSchema,
    })
    .strict(),
  findFirst: z
    .object({
      ...
      orderBy: z
        .union([
          RunsOrderByWithRelationInputObjectSchema,
          RunsOrderByWithRelationInputObjectSchema.array(),
        ])
        .optional(),
      cursor: RunsWhereUniqueInputObjectSchema.optional(),
      take: z.number().optional(),
      skip: z.number().optional(),
      distinct: z.array(RunsScalarFieldEnumSchema).optional(),
    })
    .strict(),
  findMany: z
    .object({
  ...
  create: z
    .object({
      select: z.lazy(() => RunsSelectObjectSchema.optional()),
      data: z.union([
        RunsCreateInputObjectSchema,
        RunsUncheckedCreateInputObjectSchema,
      ]),
    })
    .strict(),
  createMany: z
    .object({
      data: z.union([
        RunsCreateManyInputObjectSchema,
        z.array(RunsCreateManyInputObjectSchema),
      ]),
  ...
  update: z
    .object({
      select: z.lazy(() => RunsSelectObjectSchema.optional()),
      data: z.union([
        RunsUpdateInputObjectSchema,
        RunsUncheckedUpdateInputObjectSchema,
      ]),
      where: RunsWhereUniqueInputObjectSchema,
    })
    .strict(),
  updateMany: z
    .object({
      data: z.union([
        RunsUpdateManyMutationInputObjectSchema,
        RunsUncheckedUpdateManyInputObjectSchema,
      ]),
      where: RunsWhereInputObjectSchema.optional(),
    })
    .strict(),
  ...
  aggregate: z
    .object({
      ...
      skip: z.number().optional(),
      _count: z
        .union([z.literal(true), RunsCountAggregateInputObjectSchema])
        .optional(),
      _min: RunsMinAggregateInputObjectSchema.optional(),
  ...
  groupBy: z
    .object({
      ...
      orderBy: z
        .union([
          RunsOrderByWithAggregationInputObjectSchema,
          RunsOrderByWithAggregationInputObjectSchema.array(),
        ])
        .optional(),
      having: RunsScalarWhereWithAggregatesInputObjectSchema.optional(),
      take: z.number().optional(),
      skip: z.number().optional(),
      by: z.array(RunsScalarFieldEnumSchema),
      _count: z
        .union([z.literal(true), RunsCountAggregateInputObjectSchema])
        .optional(),
      _min: RunsMinAggregateInputObjectSchema.optional(),
