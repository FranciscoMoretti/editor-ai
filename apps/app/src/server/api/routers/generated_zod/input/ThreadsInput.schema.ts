...
export const ThreadsInputSchema = {
  findUnique: z
    .object({
      ...
      where: ThreadsWhereUniqueInputObjectSchema,
    })
    .strict(),
  findFirst: z
    .object({
      ...
      orderBy: z
        .union([
          ThreadsOrderByWithRelationInputObjectSchema,
          ThreadsOrderByWithRelationInputObjectSchema.array(),
        ])
        .optional(),
      cursor: ThreadsWhereUniqueInputObjectSchema.optional(),
      take: z.number().optional(),
      skip: z.number().optional(),
      distinct: z.array(ThreadsScalarFieldEnumSchema).optional(),
    })
    .strict(),
  findMany: z
    .object({
  ...
  create: z
    .object({
      select: z.lazy(() => ThreadsSelectObjectSchema.optional()),
      data: z.union([
        ThreadsCreateInputObjectSchema,
        ThreadsUncheckedCreateInputObjectSchema,
      ]),
    })
    .strict(),
  createMany: z
    .object({
      data: z.union([
        ThreadsCreateManyInputObjectSchema,
        z.array(ThreadsCreateManyInputObjectSchema),
      ]),
  ...
  update: z
    .object({
      select: z.lazy(() => ThreadsSelectObjectSchema.optional()),
      data: z.union([
        ThreadsUpdateInputObjectSchema,
        ThreadsUncheckedUpdateInputObjectSchema,
      ]),
      where: ThreadsWhereUniqueInputObjectSchema,
    })
    .strict(),
  updateMany: z
    .object({
      data: z.union([
        ThreadsUpdateManyMutationInputObjectSchema,
        ThreadsUncheckedUpdateManyInputObjectSchema,
      ]),
      where: ThreadsWhereInputObjectSchema.optional(),
    })
    .strict(),
  ...
  aggregate: z
    .object({
      ...
      skip: z.number().optional(),
      _count: z
        .union([z.literal(true), ThreadsCountAggregateInputObjectSchema])
        .optional(),
      _min: ThreadsMinAggregateInputObjectSchema.optional(),
      _max: ThreadsMaxAggregateInputObjectSchema.optional(),
    })
    .strict(),
  groupBy: z
    .object({
      ...
      orderBy: z
        .union([
          ThreadsOrderByWithAggregationInputObjectSchema,
          ThreadsOrderByWithAggregationInputObjectSchema.array(),
        ])
        .optional(),
      having: ThreadsScalarWhereWithAggregatesInputObjectSchema.optional(),
      take: z.number().optional(),
      skip: z.number().optional(),
      by: z.array(ThreadsScalarFieldEnumSchema),
      _count: z
        .union([z.literal(true), ThreadsCountAggregateInputObjectSchema])
        .optional(),
      _min: ThreadsMinAggregateInputObjectSchema.optional(),
