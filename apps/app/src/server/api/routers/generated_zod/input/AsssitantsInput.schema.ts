...
export const AsssitantsInputSchema = {
  findUnique: z
    .object({
      select: z.lazy(() => AsssitantsSelectObjectSchema.optional()),
      include: z.lazy(() => AsssitantsIncludeObjectSchema.optional()),
      where: AsssitantsWhereUniqueInputObjectSchema,
    })
    .strict(),
  findFirst: z
    .object({
      ...
      orderBy: z
        .union([
          AsssitantsOrderByWithRelationInputObjectSchema,
          AsssitantsOrderByWithRelationInputObjectSchema.array(),
        ])
        .optional(),
      cursor: AsssitantsWhereUniqueInputObjectSchema.optional(),
      take: z.number().optional(),
      skip: z.number().optional(),
      distinct: z.array(AsssitantsScalarFieldEnumSchema).optional(),
    })
    .strict(),
  findMany: z
    .object({
  ...
  create: z
    .object({
      ...
      include: z.lazy(() => AsssitantsIncludeObjectSchema.optional()),
      data: z.union([
        AsssitantsCreateInputObjectSchema,
        AsssitantsUncheckedCreateInputObjectSchema,
      ]),
    })
    .strict(),
  createMany: z
    .object({
      data: z.union([
        AsssitantsCreateManyInputObjectSchema,
        z.array(AsssitantsCreateManyInputObjectSchema),
      ]),
  ...
  update: z
    .object({
      ...
      include: z.lazy(() => AsssitantsIncludeObjectSchema.optional()),
      data: z.union([
        AsssitantsUpdateInputObjectSchema,
  ...
  updateMany: z
    .object({
      data: z.union([
        AsssitantsUpdateManyMutationInputObjectSchema,
        AsssitantsUncheckedUpdateManyInputObjectSchema,
      ]),
      where: AsssitantsWhereInputObjectSchema.optional(),
    })
    .strict(),
  ...
  aggregate: z
    .object({
      ...
      skip: z.number().optional(),
      _count: z
        .union([z.literal(true), AsssitantsCountAggregateInputObjectSchema])
        .optional(),
      _min: AsssitantsMinAggregateInputObjectSchema.optional(),
      _max: AsssitantsMaxAggregateInputObjectSchema.optional(),
      _avg: AsssitantsAvgAggregateInputObjectSchema.optional(),
      _sum: AsssitantsSumAggregateInputObjectSchema.optional(),
    })
    .strict(),
  groupBy: z
    .object({
      ...
      orderBy: z
        .union([
          AsssitantsOrderByWithAggregationInputObjectSchema,
          AsssitantsOrderByWithAggregationInputObjectSchema.array(),
        ])
        .optional(),
      having: AsssitantsScalarWhereWithAggregatesInputObjectSchema.optional(),
      take: z.number().optional(),
      skip: z.number().optional(),
      by: z.array(AsssitantsScalarFieldEnumSchema),
      _count: z
        .union([z.literal(true), AsssitantsCountAggregateInputObjectSchema])
        .optional(),
      _min: AsssitantsMinAggregateInputObjectSchema.optional(),
