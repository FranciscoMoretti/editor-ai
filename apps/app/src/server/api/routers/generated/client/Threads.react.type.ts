...
> {
  aggregate: {
    useQuery: <
      T extends Prisma.ThreadsAggregateArgs,
      TData = Prisma.GetThreadsAggregateType<T>,
    >(
  ...
  createMany: {
    useMutation: <T extends Prisma.ThreadsCreateManyArgs>(
      ...
      UseTRPCMutationResult<
        Prisma.BatchPayload,
        TRPCClientErrorLike<AppRouter>,
        Prisma.SelectSubset<T, Prisma.ThreadsCreateManyArgs>,
        Context
      >,
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.ThreadsCreateManyArgs>(
        variables?: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  create: {
    useMutation: <T extends Prisma.ThreadsCreateArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      UseTRPCMutationResult<
        Prisma.ThreadsGetPayload<T>,
        TRPCClientErrorLike<AppRouter>,
        Prisma.SelectSubset<T, Prisma.ThreadsCreateArgs>,
        Context
      >,
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.ThreadsCreateArgs>(
        variables: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
          ...
          Context
        >,
      ) => Promise<Prisma.ThreadsGetPayload<T>>;
    };
  };
  deleteMany: {
    useMutation: <T extends Prisma.ThreadsDeleteManyArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      UseTRPCMutationResult<
        Prisma.BatchPayload,
        TRPCClientErrorLike<AppRouter>,
        Prisma.SelectSubset<T, Prisma.ThreadsDeleteManyArgs>,
        Context
      >,
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.ThreadsDeleteManyArgs>(
        variables?: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  delete: {
    useMutation: <T extends Prisma.ThreadsDeleteArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      UseTRPCMutationResult<
        Prisma.ThreadsGetPayload<T>,
        TRPCClientErrorLike<AppRouter>,
        Prisma.SelectSubset<T, Prisma.ThreadsDeleteArgs>,
        Context
      >,
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.ThreadsDeleteArgs>(
        variables: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  findFirst: {
    useQuery: <
      T extends Prisma.ThreadsFindFirstArgs,
      TData = Prisma.ThreadsGetPayload<T> | null,
    >(
    ...
    useInfiniteQuery: <T extends Prisma.ThreadsFindFirstArgs>(
      input?: Omit<
        Prisma.SelectSubset<T, Prisma.ThreadsFindFirstArgs>,
        "cursor"
      >,
      opts?: UseTRPCInfiniteQueryOptions<
        T,
  ...
  findFirstOrThrow: {
    useQuery: <
      T extends Prisma.ThreadsFindFirstOrThrowArgs,
      TData = Prisma.ThreadsGetPayload<T>,
    >(
    ...
    useInfiniteQuery: <T extends Prisma.ThreadsFindFirstOrThrowArgs>(
      input?: Omit<
        Prisma.SelectSubset<T, Prisma.ThreadsFindFirstOrThrowArgs>,
        "cursor"
      >,
  ...
  findMany: {
    useQuery: <
      T extends Prisma.ThreadsFindManyArgs,
      TData = Array<Prisma.ThreadsGetPayload<T>>,
    >(
    ...
    useInfiniteQuery: <T extends Prisma.ThreadsFindManyArgs>(
      input?: Omit<
        Prisma.SelectSubset<T, Prisma.ThreadsFindManyArgs>,
        "cursor"
      >,
      opts?: UseTRPCInfiniteQueryOptions<
        T,
  ...
  findUnique: {
    useQuery: <
      T extends Prisma.ThreadsFindUniqueArgs,
      TData = Prisma.ThreadsGetPayload<T> | null,
    >(
    ...
    useInfiniteQuery: <T extends Prisma.ThreadsFindUniqueArgs>(
      input: Omit<
        Prisma.SelectSubset<T, Prisma.ThreadsFindUniqueArgs>,
        "cursor"
      >,
      opts?: UseTRPCInfiniteQueryOptions<
        T,
  ...
  findUniqueOrThrow: {
    useQuery: <
      T extends Prisma.ThreadsFindUniqueOrThrowArgs,
      TData = Prisma.ThreadsGetPayload<T>,
    >(
    ...
    useInfiniteQuery: <T extends Prisma.ThreadsFindUniqueOrThrowArgs>(
      input: Omit<
        Prisma.SelectSubset<T, Prisma.ThreadsFindUniqueOrThrowArgs>,
        "cursor"
      >,
      opts?: UseTRPCInfiniteQueryOptions<T, Prisma.ThreadsGetPayload<T>, Error>,
    ) => UseTRPCInfiniteQueryResult<
  ...
  groupBy: {
    useQuery: <
      T extends Prisma.ThreadsGroupByArgs,
      ...
      TData = {} extends InputErrors
        ? Prisma.GetThreadsGroupByPayload<T>
        : InputErrors,
    >(
      input: Prisma.SubsetIntersection<
        T,
        Prisma.ThreadsGroupByArgs,
        OrderByArg
      > &
        InputErrors,
      opts?: UseTRPCQueryOptions<
    ...
    >(
      input: Omit<
        Prisma.SubsetIntersection<T, Prisma.ThreadsGroupByArgs, OrderByArg> &
          InputErrors,
        "cursor"
      >,
      opts?: UseTRPCInfiniteQueryOptions<
  ...
  updateMany: {
    useMutation: <T extends Prisma.ThreadsUpdateManyArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      UseTRPCMutationResult<
        Prisma.BatchPayload,
        TRPCClientErrorLike<AppRouter>,
        Prisma.SelectSubset<T, Prisma.ThreadsUpdateManyArgs>,
        Context
      >,
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.ThreadsUpdateManyArgs>(
        variables: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  update: {
    useMutation: <T extends Prisma.ThreadsUpdateArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      UseTRPCMutationResult<
        Prisma.ThreadsGetPayload<T>,
        TRPCClientErrorLike<AppRouter>,
        Prisma.SelectSubset<T, Prisma.ThreadsUpdateArgs>,
        Context
      >,
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.ThreadsUpdateArgs>(
        variables: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  upsert: {
    useMutation: <T extends Prisma.ThreadsUpsertArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      UseTRPCMutationResult<
        Prisma.ThreadsGetPayload<T>,
        TRPCClientErrorLike<AppRouter>,
        Prisma.SelectSubset<T, Prisma.ThreadsUpsertArgs>,
        Context
      >,
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.ThreadsUpsertArgs>(
        variables: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  count: {
    useQuery: <
      T extends Prisma.ThreadsCountArgs,
      TData = "select" extends keyof T
        ? T["select"] extends true
          ? number
          : Prisma.GetScalarType<
              T["select"],
              Prisma.ThreadsCountAggregateOutputType
            >
        : number,
    >(
