...
> {
  aggregate: {
    useQuery: <
      T extends Prisma.UsersAggregateArgs,
      TData = Prisma.GetUsersAggregateType<T>,
    >(
  ...
  createMany: {
    useMutation: <T extends Prisma.UsersCreateManyArgs>(
      ...
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.UsersCreateManyArgs>(
        variables?: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  create: {
    useMutation: <T extends Prisma.UsersCreateArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.UsersCreateArgs>(
        variables: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
          ...
          Context
        >,
      ) => Promise<Prisma.UsersGetPayload<T>>;
    };
  };
  deleteMany: {
    useMutation: <T extends Prisma.UsersDeleteManyArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.UsersDeleteManyArgs>(
        variables?: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  delete: {
    useMutation: <T extends Prisma.UsersDeleteArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.UsersDeleteArgs>(
        variables: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  findFirst: {
    useQuery: <
      T extends Prisma.UsersFindFirstArgs,
      TData = Prisma.UsersGetPayload<T> | null,
    >(
  ...
  findFirstOrThrow: {
    useQuery: <
      T extends Prisma.UsersFindFirstOrThrowArgs,
      TData = Prisma.UsersGetPayload<T>,
    >(
    ...
    useInfiniteQuery: <T extends Prisma.UsersFindFirstOrThrowArgs>(
      input?: Omit<
        Prisma.SelectSubset<T, Prisma.UsersFindFirstOrThrowArgs>,
        "cursor"
      >,
  ...
  findMany: {
    useQuery: <
      T extends Prisma.UsersFindManyArgs,
      TData = Array<Prisma.UsersGetPayload<T>>,
    >(
  ...
  findUnique: {
    useQuery: <
      T extends Prisma.UsersFindUniqueArgs,
      TData = Prisma.UsersGetPayload<T> | null,
    >(
  ...
  findUniqueOrThrow: {
    useQuery: <
      T extends Prisma.UsersFindUniqueOrThrowArgs,
      TData = Prisma.UsersGetPayload<T>,
    >(
    ...
    useInfiniteQuery: <T extends Prisma.UsersFindUniqueOrThrowArgs>(
      input: Omit<
        Prisma.SelectSubset<T, Prisma.UsersFindUniqueOrThrowArgs>,
        "cursor"
      >,
      opts?: UseTRPCInfiniteQueryOptions<T, Prisma.UsersGetPayload<T>, Error>,
    ) => UseTRPCInfiniteQueryResult<
  ...
  groupBy: {
    useQuery: <
      T extends Prisma.UsersGroupByArgs,
      ...
      TData = {} extends InputErrors
        ? Prisma.GetUsersGroupByPayload<T>
        : InputErrors,
    >(
      input: Prisma.SubsetIntersection<T, Prisma.UsersGroupByArgs, OrderByArg> &
        InputErrors,
      opts?: UseTRPCQueryOptions<
    ...
    >(
      input: Omit<
        Prisma.SubsetIntersection<T, Prisma.UsersGroupByArgs, OrderByArg> &
          InputErrors,
        "cursor"
      >,
      opts?: UseTRPCInfiniteQueryOptions<
  ...
  updateMany: {
    useMutation: <T extends Prisma.UsersUpdateManyArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.UsersUpdateManyArgs>(
        variables: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  update: {
    useMutation: <T extends Prisma.UsersUpdateArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.UsersUpdateArgs>(
        variables: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  upsert: {
    useMutation: <T extends Prisma.UsersUpsertArgs>(
      opts?: UseTRPCMutationOptions<
      ...
      "mutateAsync"
    > & {
      mutateAsync: <T extends Prisma.UsersUpsertArgs>(
        variables: T,
        opts?: UseTRPCMutationOptions<
          T,
          TRPCClientErrorLike<AppRouter>,
  ...
  count: {
    useQuery: <
      T extends Prisma.UsersCountArgs,
